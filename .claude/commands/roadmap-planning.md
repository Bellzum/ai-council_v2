...
2. **Task:** "Analyze the strategic context and identify major initiatives (Epics):
   ...
   **Project Context**:
   ...
   - Tech Stack: **Project Type**: web-application
**Languages**: Python
...
print("  [a] Approve - Create Epic in azure-devops")
...
```python
print("\n:rocket: Creating Epics in azure-devops...")
...
- :white_check_mark: Epics created in azure-devops
