...
class UnifiedWorkTrackingAdapter:
    ...
    def attach_file_to_work_item(
        ...
        Args:
            ...
            comment: Optional comment for attachment

        Returns:
            Dict with keys: success, work_item_id, file_name, attachment_url (if success), error (if failure)
        """
        return self._adapter.attach_file_to_work_item(work_item_id, file_path, comment)
    ...
    def get_current_user(self) -> Optional[Dict[str, str]]:
        ...
        Returns:
            Dict with keys (for Azure DevOps):
                - id: User ID (GUID)
                - display_name: User's display name
                - email: User's email
            None for file-based adapter (no authentication)
        """
        if hasattr(self._adapter, 'get_current_user'):
...
class AzureCLIAdapter:
    ...
    def add_comment(
        ...
        return self.cli.add_comment(work_item_id, comment)
    ...
    def attach_file_to_work_item(
        ...
        """
        Attach file to work item via Azure CLI.
        ...
        try:
            result = self.cli.attach_file_to_work_item(work_item_id, path_obj, comment)
            return result
    ...
    def get_current_user(self) -> Dict[str, str]:
        ...
        Returns:
            Dict with keys:
                ...
                - email: User's email
        """
        return self.cli.get_current_user()
